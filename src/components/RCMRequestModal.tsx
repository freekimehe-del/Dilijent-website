...
interface RCMRequestModalProps {
    isOpen: boolean;
    onClose: () => void;
}

const RCMRequestModal = ({ isOpen, onClose }: RCMRequestModalProps) => {
                ...
                <div className="p-6 md:p-8 max-h-[80vh] overflow-y-auto">
                    {isSubmitted ? (
                        <div className="text-center py-12">
                            ...
                            <p className="text-gray-600">We received your request and will call you shortly.</p>
...
export default RCMRequestModal;
